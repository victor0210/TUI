...
export default {
  ...
  mounted () {
    ...
    DropMenu = new Vue({
      ...
      render (h) {
        return h('div', {
          class: 't-timepicker__list-wrapper'
        }, [h('div', {
          class: [
            't-timepicker__arrow-up',
            _this.arrowRight ? 't-timepicker__arrow-up--right' : '',
            _this.arrowTop ? 't-timepicker__arrow-up--top' : ''
          ],
          style: {
    ...
    this.action(parent, 'time-picker-drop-menu-register', dropComponent)
  },
  methods: {
    setListPosition () {
      const parent = this.select
