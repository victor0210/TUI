<template>
  <div>
    <guide title="Color 色彩" des="TUI 推荐您使用以下配色方案，致力让组件在页面的展示效果达到最佳。"/>

    <div class="demo-block without-code">
      <div class="title">主色</div>
      <div class="sub-title">TUI 推荐主色为清澈的蓝色</div>
      <div class="source">
        <t-row :gutter="20">
          <t-col :span="6">
            <div class="color-panel" style="background-color: #44A9FF">
              <div class="main">主要 Primary</div>
              <div class="sub">#44A9FF</div>
            </div>
          </t-col>
        </t-row>
      </div>
    ...
    <div class="demo-block without-code">
      <div class="title">辅助色</div>
      <div class="sub-title">除主色外的其他辅助配色，可根据不同的业务场景选择最恰当的颜色，如：成功（绿色）、信息（蓝灰色）、警告（黄色）、危险（红色）</div>
      <div class="source">
        <t-row :gutter="20">
          <t-col :span="6"><div class="color-panel" style="background-color: #2ed573"><div class="main">成功 Success</div><div class="sub">#2ED573</div></div></t-col>
          ...
          <t-col :span="6"><div class="color-panel" style="background-color: #fccc23"><div class="main">警告 Warning</div><div class="sub">#FCCC23</div></div></t-col>
          <t-col :span="6"><div class="color-panel" style="background-color: #ff5500"><div class="main">危险 Danger</div><div class="sub">#FF5500</div></div></t-col>
        </t-row>
      </div>
    </div>

    <div class="demo-block without-code">
      <div class="title">中性色</div>
      <div class="sub-title">为了更好的展示出文本、背景、边框、阴影的层次效果，提供了以下中性色</div>
      <div class="source">
        <t-row :gutter="20">
...
<style scoped>
  ...
  .color-panel.info .main,
  .color-panel.info .sub {
    color: #303030;
    font-weight: 400;
  }
</style>
